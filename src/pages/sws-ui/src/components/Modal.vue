     ...
     .fixed.z-10.inset-0.overflow-y-auto
        .flex.items-end.sm_items-center.justify-center.min-h-full.p-4.text-center.sm_p-0
          TransitionChild(
            ...
            DialogPanel.relative.bg-rose-100.rounded-lg.px-4.pt-5.pb-4.text-left.overflow-hidden.shadow-xl.transform.transition-all.sm_my-8.sm_max-w-lg.sm_w-full.sm_p-6
              .hidden.sm_block.absolute.top-0.right-0.pt-4.pr-4
                button.rounded-md.text-rose-700.hover_text-gray-500.focus_outline-none.focus_ring-none.focus_ring-indigo-500(type="button", @click="setIsOpen(false)")
                  span.sr-only Close
